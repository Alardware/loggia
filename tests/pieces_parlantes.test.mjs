...
test('« A surveiller » vit dans le rail, et plus de point « appareils hors ligne »', () => {
  assert.ok(src.includes("const ACC_RAIL = ['attention', 'meteo', 'moment', 'rappels', 'agenda'];") && src.includes("const ACC_MAIN = ['favoris', 'scenes', 'pieces', 'cameras'];"), 'dans le rail, en tete');
