...
| [0040](0040-sept-familles-un-bandeau-en-tete-les-entites-par-vue.md) | Sept familles d'objets (IoT, Capteurs élargis, plus de puce Caméras) ; le bandeau d'édition premier enfant de toutes les vues ; Paramètres sans barre de mode ni onglet Entités — la météo dans la fiche de l'Accueil | appliqué (v3.41.0) |
